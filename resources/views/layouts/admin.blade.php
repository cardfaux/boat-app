...
<body class="app">
  ...
  <script>
    window.addEventListener("load", (function () { const t = document.getElementById("loader"); setTimeout((function () { t.classList.add("fadeOut") }), 300) }))
  </script>
  <div>
    <!-- #Left Sidebar ==================== -->
          ...
          <ul class="nav-right">
            ...
            <li class="notifications dropdown"><span class="counter bgc-blue">3</span> <a href=""
              ...
              <ul class="dropdown-menu">
                    ...
                    <li><a href="" class="peers fxw-nw td-n p-20 bdB c-grey-800 cH-blue bgcH-grey-100">
                        ...
                        <div class="peer peer-greed">
                          <div>
                            ...
                            </div><span class="c-grey-600 fsz-sm">Want to create your own customized data generator for
                              your app...</span>
                          </div>
                        </div>
                      </a></li>
                ...
                <li class="pX-20 pY-15 ta-c bdT"><span><a href="email.html" class="c-grey-600 cH-blue fsz-sm td-n">View
                      All Email <i class="fs-xs ti-angle-right mL-10"></i></a></span></li>
              </ul>
            </li>
